...
import 'package:bengkel_online_flutter/feature/admin/screens/submit_report_screen.dart';
...
class _ReportListScreenState extends State<ReportListScreen> {
  ...
  Future<void> _loadReports() async {
    ...
    try {
      // Admin version - using admin-specific endpoint
      final result = await _reportService.getReports(page: _currentPage, isAdmin: true);
      setState(() {
