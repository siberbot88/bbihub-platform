<div class="p-6">
    <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-md p-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                <svg class="w-8 h-8 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 11c0 1.657-1.567 3-3.5 3S5 12.657 5 11 6.567 8 8.5 8 12 9.343 12 11zM12 11v9" />
                </svg>
                <div>
            ...
            <a href="{{ route('admin.data-center') }}" wire:navigate
        ...
        <form wire:submit.prevent="save" class="mt-6 space-y-4">
            ...
            <div>
                ...
                <input type="text" value="{{ $category }}" disabled
                    class="block w-full rounded-md border-gray-200 bg-gray-50 px-3 py-2" />
            </div>
            ...
            @if($category === 'users')
                <div>
                    ...
                    <select wire:model.defer="role"
                        class="block w-full rounded-md border-gray-200 shadow-sm focus:ring-red-200 focus:border-red-300 px-3 py-2">
                ...
                <div>
                    ...
                    <input type="email" wire:model.defer="email"
                        class="block w-full rounded-md border-gray-200 px-3 py-2" />
                    @error('email') <div class="text-sm text-red-600 mt-1">{{ $message }}</div> @enderror
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Password (kosongkan untuk tidak
                        mengubah)</label>
                ...
                <div>
                    ...
                    <input type="text" wire:model.defer="specialist"
                        class="block w-full rounded-md border-gray-200 px-3 py-2" />
